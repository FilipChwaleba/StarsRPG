...
//		//GETTYPE
//private:
//	Consumable(std::string name, wellType w = 1u, itemcount q = 1, Buff* ef = nullptr)
...
class Item final{ 
public:
	 ItemDelegate* GetData()const { return _data; }
...
private:
	...
	//niepotrzebne, trzeba bêdzie usun¹æ razem z fragmentem kodu który krzyczy ¿e potrzebuje tych operatorów aby dzia³aæ
